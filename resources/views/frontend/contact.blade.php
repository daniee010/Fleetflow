    ...
    <section class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] py-16 px-8">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                {{-- Form --}}
                <form action="{{ route('contact.submit') }}" method="POST" class="bg-white dark:bg-[#161615] rounded-lg shadow-lg p-8">
                    @csrf
                    @if(session('success'))
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" class="w-full border border-gray-300 dark:border-[#3E3E3A] rounded-md px-4 py-2 focus:ring-2 focus:ring-[#f53003] focus:outline-none dark:bg-[#0a0a0a]" required>
                    </div>
                    <div class="mb-5">
                        <label for="email" class="block font-semibold mb-2">Email Address</label>
                        <input type="email" name="email" id="email" class="w-full border border-gray-300 dark:border-[#3E3E3A] rounded-md px-4 py-2 focus:ring-2 focus:ring-[#f53003] focus:outline-none dark:bg-[#0a0a0a]" required>
                    </div>
                    <div class="mb-5">
                        <label for="message" class="block font-semibold mb-2">Message</label>
                        <textarea name="message" id="message" rows="5" class="w-full border border-gray-300 dark:border-[#3E3E3A] rounded-md px-4 py-2 focus:ring-2 focus:ring-[#f53003] focus:outline-none dark:bg-[#0a0a0a]" required></textarea>
                    </div>
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <p class="text-gray-600 dark:text-[#A1A09A]">

            ...
            <table class="min-w-full text-sm">
                ...
                @forelse($contracts as $c)
                    <tr class="border-t border-gray-200 dark:border-[#2a2a2a]">
                        ...
                        <td class="px-4 py-3">{{ \Illuminate\Support\Carbon::parse($c->start_date)->toDateString() }}</td>
                        <td class="px-4 py-3">{{ \Illuminate\Support\Carbon::parse($c->end_date)->toDateString() }}</td>
                        <td class="px-4 py-3">${{ number_format($c->weekly_payment, 2) }}</td>
                        <td class="px-4 py-3">
